/* vala-dmap-container-db.c generated by valac 0.56.9, the Vala compiler
                                      ...
                                      gpointer klass)
{
	...
	_tmp0_ = gee_array_list_new (dmap_container_record_get_type (), (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL);
	self->priv->db = _tmp0_;
}
...
vala_dmap_container_db_get_type_once (void)
{
	...
	g_type_add_interface_static (vala_dmap_container_db_type_id, dmap_container_db_get_type (), &dmap_container_db_info);
